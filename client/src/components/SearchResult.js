...
const ResultCard = ({ result }) => (
  <Link className="result-card" to={`/exercises/exercise/${result.id}`}>
    <Box sx={{border:'4px solid #DC3545', marginTop:1,marginBottom:1, width:'300px', borderRadius:'4px',backgroundColor:"#FFF", cursor:'pointer'}}>
